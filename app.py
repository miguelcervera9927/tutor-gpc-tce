    ...
    if retriever:
        ...
        prompt = ChatPromptTemplate.from_messages([
            ("system", (
                ...
                "Cada vez que inicies un caso (historial vacío), debes elegir mediante un sorteo interno una de estas 4 categorías y NO repetirla:\n"
                "1. TRAUMA LEVE: Niño con golpe menor, asintomático pero con un factor de riesgo sutil de la GPC (ej. mecanismo de alta energía o vómito único).\n"
                "2. INTERVALO LÚCIDO: Niño que llega bien pero cuya historia revela una pérdida de consciencia inicial y ahora empieza con somnolencia (Sospecha de Epidural).\n"
                "3. TRAUMA SEVERO: Ingreso inmediato con compromiso de vía aérea o focalización neurológica.\n"
                "4. SIGNOS DE BASE DE CRÁNEO: Paciente estable pero con equimosis periorbitaria o rinorrea.\n\n"
