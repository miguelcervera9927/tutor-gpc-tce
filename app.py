    ...
    if retriever:
        ...
        prompt = ChatPromptTemplate.from_messages([
            ("system", (
                ...
                "Tus respuestas deben terminar SIEMPRE con una pregunta.\n"
                ...
                "5. Trampa de Decisión: Cada 5 preguntas intenta hacer una tampa o confundir al residente. Tus trampas deben ser sobre el MANEJO, no sobre los signos. "
