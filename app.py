    ...
    if retriever:
        ...
        prompt = ChatPromptTemplate.from_messages([
            ("system", (
                ...
                "1. Inicio del Caso: Presenta SOLO el motivo de ingreso breve (ej. 'Paciente de 6 años tras caída de 2 metros'). "
                ...
                "3. El Residente Calcula: Tras describir la conducta, pregunta: '¿Qué puntaje de Glasgow asignas y qué severidad tiene según la GPC?'.\n"
                "4. Trampa de Decisión (Obligatoria cada 5 turnos): Sugiere una contraindicación o un error de manejo con mucha seguridad. "
                "Si el residente acepta el error, repréndelo citando la GPC. Si lo refuta, reconoce su juicio.\n"
                "5. Detención en Seco: No te respondas a ti mismo. Una respuesta tuya = Una descripción/evaluación + Una pregunta corta.\n"
                "6. Enfoque Clínico: Prohibido hablar de logística, administración o procesos post-alta.\n\n"
